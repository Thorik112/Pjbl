    ...
    <div id="wrapper">
        ...
        ?>
                ...
                <div class="container-fluid">
                        ...
                        if ($kirim) {
                            $query = "INSERT INTO tb_game (game, gambar, deskripsi) VALUES ('$game','$gambar','$deskripsi')";

                                if ($koneksi->query($query) === TRUE) {
                                    echo "<script>window.alert('Data Berhasil Tersimpan')
                window.location='kelola_game.php'</script>";
                                } else {
                                    echo "<script>window.alert('Data gagal tersimpan')
                window.location='create_game.php'</script>";
                                }
                            }
                        ?>
                </div>
