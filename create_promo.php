    ...
    <div id="wrapper">
        ...
        ?>
                ...
                <div class="container-fluid">
                        ...
                        <form action="create_promo.php" method="post" enctype="multipart/form-data">
                            <h2>Create Promo</h2>
                            <div class="form-group">
                                <label for="id">ID:</label>
                                <input type="text" name="id" value="auto" id="id" disabled>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="discount" min="1" max="50" required="required" />
                            </div>
                            <div class="form-group">
...
if ($kirim) {
    $query = mysqli_query($koneksi, "SELECT * FROM `tb_promo` WHERE `coupon_code` = '$coupon_code'") or die(mysqli_error($koneksi));
    $row = mysqli_num_rows($query);

    if ($row > 0) {
        echo "<script>alert('Coupon Sudah Ada')</script>";
        echo "<script>window.location = 'kelola_promo.php'</script>";
    } else {
        $insertQuery = mysqli_query($koneksi, "INSERT INTO tb_promo (promo, tanggal, gambar, coupon_code, discount, status) VALUES ('$promo','$waktu','$gambar','$coupon_code', '$discount', '$status')") or die(mysqli_error($koneksi));

        if ($insertQuery) {
            echo "<script>window.alert('Data Berhasil Tersimpan')
            window.location='kelola_promo.php'</script>";
        } else {
            echo "<script>window.alert('Data gagal tersimpan')
            window.location='create_promo.php'</script>";
        }
    }
}
?>
