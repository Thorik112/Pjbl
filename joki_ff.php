		...
		<div class="container">
			<div class="row">
				<div class="col-lg-4 mb-5 mb-lg-0">
					<h4 class="comment-title">Joki FF BR Ranked</h4>
				...
				<div class="col-lg-8">
					<div class="contact-form-warp">
						...
						<h6>Harga/Rank</h6>
						<p>Platinum 15000 | Diamond 1 & 2 25000 | Diamond 3 50000 | diamond 4 75000 | Master 1 & 2 100000 | Master 3 & 4 125000 | Master 5 150000<p>
							<div class="row">
								<div class="col-md-12">
								...
								<div class="input_group">
											<div class="input_box">
												...
												<input type="radio" id="b8" name="rank" class="radio" value="diamond1&2">
												<label for="b8">Diamond 1 & 2</label>
												<input type="radio" id="b9" name="rank" class="radio" value="diamond3">
												<label for="b9">Diamond 3</label>
												<input type="radio" id="b10" name="rank" class="radio" value="diamond4">
												<label for="b10">Diamond 4</label>
												<input type="radio" id="b11" name="rank" class="radio" value="master1&2">
												<label for="b11">Master 1 & 2</label>
												<input type="radio" id="b6" name="rank" class="radio" value="master3&4">
												<label for="b6">Master 3 & 4</label>
												<input type="radio" id="b7" name="rank" class="radio" value="master5">
												<label for="b7">Master 5</label>
											</div>
								</div>
									<div class="col-lg-12">
										<input type="number" placeholder="Berapa Rank" id="bintang" required name="bintang">
								</div>
								<div class="col-lg-12">
			...
			<div class="input_box">
				...
				<script>
										...
										function updateTotal() {
											var totalBayar = 0;
											if (game1.checked) {
												totalBayar += 15000 * parseFloat(bintang.value);
											}
											if (game2.checked) {
												totalBayar += 25000 * parseFloat(bintang.value);
											}
											if (game3.checked) {
												totalBayar += 50000 * parseFloat(bintang.value);
											}
											if (game4.checked) {
												totalBayar += 75000 * parseFloat(bintang.value);
											}
											if (game5.checked) {
												totalBayar += 100000 * parseFloat(bintang.value);
											}
											if (game6.checked) {
												totalBayar += 125000 * parseFloat(bintang.value);
											}
											if (game7.checked) {
												totalBayar += 150000 * parseFloat(bintang.value);
											}
