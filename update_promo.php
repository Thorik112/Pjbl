...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        ?>
                ...
                $query = "SELECT * FROM tb_promo WHERE id_promo='$id_promo'";
                $hasil = mysqli_query($koneksi, $query);
                ...
                ?>
                        ...
                        <form action="proses_update_promo.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="id" value="<?php echo $data['id_promo']; ?>" id="id" readonly>
                            </div>
                            <div class="form-group">
                                <label for="promo">Promo:</label>
                                <input type="text" name="promo" id="promo" value="<?php echo $data['promo']; ?>" required>
                            </div>
                            <div class="form-group">
                                <label for="waktu">Waktu:</label>
                                <input type="date" name="waktu" id="waktu" value="<?php echo $data['tanggal']; ?>" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="discount" min="1" max="50" required="required" value="<?php echo $data['discount']; ?>"/>
                            </div>
                            <div class="form-group">
