...
?>
	...
	<div class="container" style="margin-bottom: 5%; margin-top: 5%;">
				...
				$nama = $_SESSION['nama'];
                            include "koneksi.php";
                            $query = "SELECT * FROM tb_koin WHERE nama='$nama' ORDER BY id_koin ASC";
                            $hasil = mysqli_query($koneksi, $query);
                            $no = 1;
                            $jum = mysqli_num_rows($hasil);
        ...
        <table id="example" class="table table-striped table-bordered" style="margin-bottom: 10%;">
            <thead>
                <tr>
                    <th scope="col">ID</th>
                    <th scope="col">Jumlah Isi Koin</th>
                    <th scope="col">Waktu Isi Koin</th>
            ...
            <tbody>
              ...
              while ($data = mysqli_fetch_array($hasil)) {
                ...
                <tr>
                    ...
                    <td><?php echo $data['waktu_isi_koin']; ?></td>
										<td><img src="file/<?php echo $data['bukti'] ; ?>" width="150px" height="120px" style="border-radius: 0%; width: 150px; height: 120px;"></td>
