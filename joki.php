...
?>
	...
	<section class="recent-game-section spad set-bg" data-setbg="img/recent-game-bg.png">
		<div class="container">
			<div class="section-title">
				<h2>Pilih Siapa yang Kamu Percaya</h2>
			</div>
			<div class="row">
			<?php
    $jenis = "Joki";
    ...
    // Menggunakan operator LIKE untuk mencari data yang mengandung "Mobile Legends Bang Bang"
    $query = "SELECT * FROM tb_akun WHERE jenis='$jenis' AND status = 'online' AND game LIKE '%$game%'";
    $hasil = mysqli_query($koneksi, $query);
    ...
    ?>
            ...
            <div class="baru">
              <div class="image">
							<div class="cata racing"><?php echo $data['kategori']; ?></div>
                <div class="rgi-thumb set-bg" data-setbg=""><img src="file/<?php echo $image; ?>" title="<?php echo $image; ?>">
								<?php
                                if (strpos($data['game'], 'Mobile Legends Bang Bang') !== false) {
                            ?>
                  <div class="baru2">
                    <div class="cata new"><a href="joki_mlbb.php?penjoki=<?php echo $data['nama']; ?>&&email=<?php echo $data['email']; ?>">Pilih</a></div>
                  </div>
									<?php
											}
									?>
