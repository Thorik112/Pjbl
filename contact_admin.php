				...
				<div class="col-lg-8">
					<div class="contact-form-warp">
						...
						<form class="comment-form" action="" method="POST">
							<div class="row">
								<div class="col-md-6">
									<input type="text" name="nama" placeholder="Nama" value="<?php echo $_SESSION['nama']; ?>" required readonly>
								</div>
								<?php
								$nama_yang_diinginkan = $_SESSION['nama'];

								// Query untuk mendapatkan email berdasarkan nama
								$query = "SELECT email FROM tb_akun WHERE nama = '$nama_yang_diinginkan'";
