    ...
    <div id="wrapper">
        ...
        ?>
                ...
                ?>
                        ...
                        <form action="proses_update_game.php" method="post" enctype="multipart/form-data">
                            <h2>Update Game</h2>
                            <div class="form-group">
                                <label for="id">ID:</label>
                                <input type="text" name="id" value="<?php echo $data['id_game']; ?>" id="id" readonly>
                            </div>
                            <div class="form-group">
                                <label for="game">Game:</label>
                                <input type="text" name="game" id="game" value="<?php echo $data['game']; ?>" required>
                            </div>
                            <div class="form-group">
