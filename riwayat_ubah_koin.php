	...
	<header class="header-section">
        ...
        <ul class="profile-dropdown-list">
          ...
          <ul class="dropdown-menu" style="height: 150px; width: 200px;">
            <li><a class="dropdown-item text-dark" href="riwayat_ubah_koin.php" style="width: 70%;">Riwayat Ubah Koin</a></li>
...
?>
	...
	<div class="container" style="margin-bottom: 5%; margin-top: 5%;">
				...
				$nama = $_SESSION['nama'];
                            include "koneksi.php";
                            $query = "SELECT * FROM tb_ubah_koin WHERE nama='$nama' ORDER BY id_ubah_koin ASC";
                            $hasil = mysqli_query($koneksi, $query);
                            $no = 1;
                            $jum = mysqli_num_rows($hasil);
                ...
                <tr>
                    ...
                    <td><?php echo $data['waktu_permintaan']; ?></td>
										<td><?php
											...
											?>
											<img src="file/<?php echo $data['bukti'] ; ?>" width="150px" height="120px" style="border-radius: 0%; width: 150px; height: 120px;">
											<?php
							}
							?>
										</td>
										<td><?= $data['status'] === 'menunggu' ? '<h5><span class="badge badge-warning">Menunggu</span></h5>' 
										: ($data['status'] === 'ditolak' ? '<h5><span class="badge badge-danger">DiTolak</span></h5>' 
										:'<h5><span class="badge badge-success">terima</span></h5>') ?></td>
                </tr>
								<?php
							}
							?>
