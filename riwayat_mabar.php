...
?>
	...
	<?php 
         include "koneksi.php";
				 $nama = $_SESSION['nama'];
         $query = "SELECT * FROM transaksi_mabar WHERE nama_pemesan = '$nama'";
         $hasil = mysqli_query($koneksi, $query);
				 $no = 1;
				 $jum = mysqli_num_rows($hasil);
				 if ($jum > 0) {
...
<div class="transaction-history">
	...
	<div class="transaction-item">
			<div class="transaction-header">
				 <h3 class="text-white">No. Pesanan: <?php echo $data['id_mabar']; ?></h3>
			...
			<div class="transaction-details text-white">
					...
					<p>Nama Penjoki: <?php echo $data['nama_pemain']; ?></p>
				...
				?>
				<h3 style="text-align: center; margin-top: 40px; margin-bottom: 40px;">Anda Belum Melakukan Pesanan Mabar Apapun</h3>
