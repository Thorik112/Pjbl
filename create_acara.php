    ...
    <div id="wrapper">
        ...
        ?>
                ...
                <div class="container-fluid">
                        ...
                        <form action="create_acara.php" method="post" enctype="multipart/form-data">
                            <h2>Create Acara</h2>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="deskripsi" cols="50" rows="7"></textarea>
                            </div>
                            <div class="form-group">
                        ...
                        if ($kirim) {
                            $query = "INSERT INTO tb_acara (nama_game, acara, waktu, gambar, deskripsi) VALUES ('$game','$acara','$waktu','$gambar','$deskripsi')";

                                if ($koneksi->query($query) === TRUE) {
                                    echo "<script>window.alert('Data Berhasil Tersimpan')
                window.location='kelola_acara.php'</script>";
                                } else {
                                    echo "<script>window.alert('Data gagal tersimpan')
                window.location='create_acara.php'</script>";
                                }
                            }
                        ?>
                </div>
