...
displayNotifications($_SESSION['nama']);
?>
<!DOCTYPE html>
<html lang="zxx">
<head>
								...
								<div class="form-group">
										...
										<tr>
											<td><div class="form-check">
												<input type="checkbox" class="form-check-input" name="game[]" value="Mobile Legends Bang Bang" <?php if(in_array('Mobile Legends Bang Bang', $game_string)) echo 'checked'; ?>>
												<label class="form-check-label" style="color: #fff;">MLBB</label><br>
												<input type="checkbox" class="form-check-input" name="game[]" value="Free Fire" <?php if(in_array('Free Fire', $game_string)) echo 'checked'; ?>>
												<label class="form-check-label" style="color: #fff;">Free Fire</label><br>
												<input type="checkbox" class="form-check-input" name="game[]" value="Fifa Mobile" <?php if(in_array('Fifa Mobile', $game_string)) echo 'checked'; ?>>
												<label class="form-check-label" style="color: #fff;">Fifa Mobile</label><br>
												<input type="checkbox" class="form-check-input" name="game[]" value="PUBG" <?php if(in_array('PUBG', $game_string)) echo 'checked'; ?>>
												<label class="form-check-label" style="color: #fff;">PUBG</label>
										</div></td>
									</tr>
										</table>
								</div>
